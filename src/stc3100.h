...
/* ******************************************************************************** */
#define SENSERESISTOR  10    // sense resistor value in milliOhms (10min, 100max)
...
extern short s16_BattVoltage;     // battery voltage in mV
extern short s16_BattCurrent;     // battery current in mA
extern short s16_BattTemperature; // battery temperature in 0.1C
extern short s16_BattChargeCount; // Coulomb counter value in mAh
extern short s16_BattChargeCountRAW; // Coulomb counter value in mAh
extern short s16_BattChargeCountRAW2; // Coulomb counter value in mAh
extern short s16_BattCounter;     // conv counter
